...
# try:
# regresso = pickle.load(open(r'T:\\Project\\Project\\crime hotspots\\model\\model\\murder.pkl','rb'))
# sandy = pickle.load(open(r'T:\\Project\\Project\\crime hotspots\\model\\theft.pkl','rb'))
# rap = pickle.load(open(r'T:\\Proect\\Project\\crime hotspots\\model\\rap.pkl','rb'))
# last = pickle.load(open(r'T:\\Project\\Project\\crime hotspots\\model\\total.pkl','rb'))
